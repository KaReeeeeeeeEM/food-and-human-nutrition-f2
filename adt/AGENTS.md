# Food and Human Nutrition for Secondary Schools: Student’s Book Form Two — ADT Bundle Reference
...
**Food and Human Nutrition for Secondary Schools: Student’s Book Form Two** — This is an English-language secondary school textbook from Tanzania, published by the Tanzania Institute of Education for Form Two students, roughly equivalent to lower secondary or early high school level. It introduces practical food and nutrition topics such as food additives, cereals, malnutrition, and meal planning, with strong attention to health, local foods, and everyday cooking skills. The book uses a competency-based, student-centered approach with activities, recipes, revision exercises, and real-life applications, emphasizing balanced diets, disease prevention, and preparing suitable meals for different groups of people.
...
├── food-and-human-nutrition-f2.db                    # SQLite database (pipeline state)
├── food-and-human-nutrition-f2.pdf                   # Original source PDF
...
```json
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "",
  "qz001_que": "What is the main purpose of food additives in food?",
  "qz001_o0": "1) To give nutrients",
  "qz001_o0_exp": "❌ Not quite. The text says food additives do not provide nutrients."
}
```
...
```json
{
  "title": "Food and Human Nutrition for Secondary Schools: Student’s Book Form Two",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en"
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">What is the main purpose of food additives in food?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Not quite. The text says food additives do not provide nutrients." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) To give nutrients</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `food-and-human-nutrition-f2.pdf` |
| Pipeline database | `food-and-human-nutrition-f2.db` (SQLite) |
